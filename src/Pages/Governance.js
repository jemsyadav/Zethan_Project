      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            ...
            <div className="Goverenance_Paragraph">
              ...
              >
                In governance, staking $Zeth gives you veZETH, a token that
                signifies your participation. You can <br /> use it to make
                proposals and vote on the future of the DAO.
              </p>
            </div>
        ...
        <div className="row" style={{ paddingBottom: "2rem" }}>
          ...
          >
            <div className="row">
              <div className="col-lg-6">
                <div
                  className="Main_Box_Governance_Logo"
                  style={{ display: "flex" }}
                >
          ...
          <div className="col-lg-6" style={{ textAlign: "center" }}>
            <div
              className="Main_DIv_Governence_6"
              style={{
                display: "flex",
                color: "white",
                gap: "3rem",
            ...
            >
              <div className="TreasuryBalance">
                ...
                <h2>$ 82.16</h2>
                <p
                  style={{ paddingTop: "3rem", color: "rgba(255,255,255,0.5)" }}
                >
                  Marketplace Revenue
                </p>
                <h2>$ 142.46</h2>
